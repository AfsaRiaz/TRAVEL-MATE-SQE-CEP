...
<!-- login button -->
    <!-- <h6 class="mt-8 mb-0"><a class="button" href="#">Login  <i class="fa fa-sign-in ms-1"></i></a></h6> -->
  ...
  <p class="mt-3 mb-0">Don't have an account? <a class="col_oran" href="register.php">Register</a></p>
  </form>
   </div>
  </div>  
 </div>
